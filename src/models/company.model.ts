...
export const newCompanySchema = Joi.object().keys({
    ...
    telefone: Joi.string().regex(
        /(^[1-9]{1}[0-9]{1}[1-9]{8}$)|(^[1-9]{1}[0-9]{1}[9]{1}[1-9]{8}$)/
    ).required(),
...
//o FirestroeDataConverter é uma forma de assegurar a padronização do que vem ou vai ao banco firestore
export const companyCoverter: FirestoreDataConverter<Company> = {
